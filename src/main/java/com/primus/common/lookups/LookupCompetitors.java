...
public class LookupCompetitors implements ILookupService {
    ...
    public Map<String, String> lookupData(IRadsContext iRadsContext, String searchString, int from, int noRecords, String s1, List<String> list) {
        ...
        CompetitorService service = CommonUtil.getCompetitorService();
        ...
        for (ModelObject obj :  companies) {
            ans.put(((Competitor)obj).getName(),((Competitor)obj).getName());
        }
